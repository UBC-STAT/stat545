...
[**Step 6:**]{.underline} Run `library(devtools)` in the Console. Then, run `use_git()` and choose the option that means yes. Then, run `use_github()` to create a GitHub repository for your website. 
