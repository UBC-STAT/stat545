...
**Each pull request will require a number of components (listed below). TAs will grade one pull request per person, and it's up to you to ensure you've indicated which one is to be graded by adding "(GRADED)" to your pull request name.**

Every teammate should submit at least one pull request for this deliverable, and have a **different** teammate merge the pull request after reviewing the contents of the pull request. So, like the previous exercise on Markdown Formatting, this exercise is not stand-alone. You’ll need to decide who will work on what.
...
**Note 2:** Please indicate to the TAs which PRs you would like to be graded by adding “(GRADED)” to the PR name. Every team member should have exactly one pull request labelled "(GRADED)".
...
5.  Put a link to that release as a submission on the Collaborative Project Deliverable 2 (only one person per team needs to do this)
