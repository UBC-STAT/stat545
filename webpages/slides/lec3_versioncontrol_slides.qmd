...
-  "Git" is a version control system designed to track changes. 

-  Git essentially creates "snapshots" of your work as you progress through a project. 
...
![](../lectures_i/images/GitHubBasic.png){width=800 fig-align="center"} 
...
-  After changes are committed locally (on your computer), we can **push** them to a GitHub repository. 

-  This sends the changes and updates the most recent version of your project on GitHub. 

-  We can also **pull** changes from GitHub to your local machine. This is useful when multiple people (or perhaps one person on multiple devices) are working on a project. 
...
-  We will demonstrate how Git and GitHub can be used within an **R Project**.

  -  R Projects are useful for organizing files and resources specific to a project in a self-contained directory. 
  -  R Projects allow for more reproducible workflows, and allow users to resume exactly where they left off within a project by keeping variables in the environment even after the session has closed.
...
*Side note here: the newer version of RStudio (called Positron) does not use R Projects. Instead, you can create a "folder". All other steps will be pretty much the same!*

# Syncing GitHub and RStudio: "GitHub First"


## Syncing: "GITHUB FIRST"

### Step 1: Create a GitHub Repository

-  1.1: Go to your GitHub profile (mine is at https://github.com/grcetmpk)
...
You are now redirected to the repository main page. The repository page tells you you have 1 commit. 

Click on it to get to the history page. This tells you all the changes that have been tracked for the files in the repository so far.
...
![](../lectures_i/images/gitclonehttps.png){width=800 fig-align="center"}
...
# Syncing GitHub and RStudio: "RStudio First"


## Syncing: "RSTUDIO FIRST"
...
-  1.3:  Select "New Directory", "New Project", and name it "demo-rstudio-first-[initials]". 

    -  Select "Browse" and find a location where you'd like to save your project (a new folder the same name as your project will be created). 
    -  I chose the Desktop as an example. Ensure "Create a Git Repository" is selected. Click "Create Project".

![](../lectures_i/images/NewRProject.png){width=400 fig-align="center"}
...
*If you have issues, see the last section of [Lecture 1A: Installation](../lectures_i/lec1a_installation.qmd) to set up your GitHub credentials on RStudio.*





# Syncing Your Changes Between RStudioand GitHub

## Syncing Your Changes

**At this point, regardless of whether you started with RStudio or GitHub, the steps are the same.**

-  One way or another, you have a GitHub repository connected to RStudio. 
...
![](../lectures_i/images/GitHubFullFlow.png){width=800 fig-align="center"}
...
There are two ways that I'll show you how to interact with GitHub through RStudio.
...
![](../lectures_i/images/gitpane.png){width=400 fig-align="center"}
...
![](../lectures_i/images/staging.png){width=400 fig-align="center"}
...
![](../lectures_i/images/commit.png){width=900 fig-align="center"}
...
![](../lectures_i/images/repowithchanges.png){width=600 fig-align="center"}
...
Let's edit the README.md file on GitHub. Click the pencil icon at the bottom of the repository where the README appears, change or add some text, and click the green "Commit Changes" button. 
...
-  When creating a repository, a default branch is created. This is typically named "main" (or in older repositories, "master"). 
  -  The default branch is the branch that GitHub displays when anyone visits your repository. 
...
### Branches
-  To create a new branch, you can either navigate to the Git pane and click the icon with two purple rectangles connected to a white diamond. 
-  Here, you can create a new branch and name it. Then, you can switch between branches using the drop down menu beside it (see below). 


![](../lectures_i/images/createbranch.png){width=800 fig-align="center"}


![](../lectures_i/images/switchbranch.png){width=800 fig-align="center"}
...
You can make changes on your new branch, and push them to that branch on GitHub. 
...
![](../lectures_i/images/githubmessage.png){width=800 fig-align="center"}
